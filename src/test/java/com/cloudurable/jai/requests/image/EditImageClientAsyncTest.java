...
public class EditImageClientAsyncTest {
    HttpClient httpClientMock;
    OpenAIClient client;
    String responseBody;
    String contentType;
    byte[] requestBody;
    EditImageRequest imageRequest;
    ...
    void editImageAsync() throws Exception {
        ...
        final ClientResponse<EditImageRequest, ImageResponse> response = client.editImageAsync(imageRequest).get();
    ...
    void before() {
        ...
        imageRequest = EditImageRequest.builder()
                .responseFormat(ImageResponseFormat.URL)
                .prompt("Edit me")
                .imageFile(new File("super_hero.png"))
                .build();

        final MultipartEntityBuilder form = ImageRequestSerializer.buildEditForm(imageRequest);
