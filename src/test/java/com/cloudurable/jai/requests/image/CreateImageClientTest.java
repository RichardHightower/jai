...
public class CreateImageClientTest {
    ...
    void createImage() throws Exception {
        ...
        // Mock the response
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponsePost("/images/generations", requestBody, responseBody);

        final ClientResponse<CreateImageRequest, ImageResponse> response = client.createImage(createImageRequest);
