package com.cloudurable.jai.requests.audio;
...
public class TranslateClientAsyncTest {
    ...
    void embeddingAsync() throws Exception {
        ...
        final CompletableFuture<ClientResponse<TranslateRequest, AudioResponse>> responseFuture = client.translateAsync(translateRequest);

        ClientResponse<TranslateRequest, AudioResponse> response = responseFuture.get();
    ...
    void before() {
        ...
        final MultipartEntityBuilder form = AudioRequestSerializer.buildForm(translateRequest);
