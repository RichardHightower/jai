...
public class TranscribeClientAsyncTest {
    ...
    void embeddingAsync() throws Exception {
        ...
        final CompletableFuture<ClientResponse<TranscriptionRequest, AudioResponse>> responseFuture = client.transcribeAsync(transcriptionRequest);

        ClientResponse<TranscriptionRequest, AudioResponse> response = responseFuture.get();
