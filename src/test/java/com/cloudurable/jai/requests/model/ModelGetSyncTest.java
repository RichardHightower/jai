...
class ModelGetSyncTest {
    ...
    void getModel() throws Exception {
        ...
        //Mock it
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponseGet("/models/foo", responseBody);


        ModelData response = client.getModel("foo");
