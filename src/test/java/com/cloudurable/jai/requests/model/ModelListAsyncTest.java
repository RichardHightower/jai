package com.cloudurable.jai.requests.model;
...
class ModelListAsyncTest {
     ...
     */
    @Test
    void listModelAsync() throws Exception {
        ...
        //Mock it
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponseGetAsync("/models", responseBody);


        ModelListResponse response = client.listModelsAsync().get();
