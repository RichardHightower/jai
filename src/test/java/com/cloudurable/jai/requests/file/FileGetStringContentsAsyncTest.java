 ...
 */
class FileGetStringContentsAsyncTest {
    ...
    void getFile() throws Exception {
        ...
        //Mock it
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponseGetAsyncNoContentTypeAsync("/files/file-ccdDZrC3iZVNiQVeEA6Z66wf/content", responseBody);


        String body = client.getFileContentStringAsync("file-ccdDZrC3iZVNiQVeEA6Z66wf").get();
