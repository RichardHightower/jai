...
class FileGetSyncTest {
    ...
    void getFile() throws Exception {
        ...
        //Mock it
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponseGet("/files/file-ccdDZrC3iZVNiQVeEA6Z66wf", responseBody);


        FileData response = client.getFileData("file-ccdDZrC3iZVNiQVeEA6Z66wf");
