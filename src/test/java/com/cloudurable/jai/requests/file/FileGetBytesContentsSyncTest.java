 ...
 */
class FileGetBytesContentsSyncTest {
    ...
    void getFile() throws Exception {
        ...
        //Mock it
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponseGet("/files/file-ccdDZrC3iZVNiQVeEA6Z66wf/content", responseBody.getBytes(StandardCharsets.UTF_8));


        byte[] body = client.getFileContentBinary("file-ccdDZrC3iZVNiQVeEA6Z66wf");
        ...
        verify(mock, times(1)).send(requestResponse.getRequest(), HttpResponse.BodyHandlers.ofByteArray());
