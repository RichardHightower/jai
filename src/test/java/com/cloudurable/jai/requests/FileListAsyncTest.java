...
class FileListAsyncTest {
    ...
    void listFiles() throws Exception {
        ...
        //Mock it
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponseGetAsync("/files", responseBody);


        FileListResponse response = client.listFilesAsync().get();
