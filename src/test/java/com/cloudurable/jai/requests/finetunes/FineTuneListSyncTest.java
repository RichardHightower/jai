...
class FineTuneListSyncTest {
    ...
    void listFineTunesAsync() throws Exception {
        ...
        //Mock it
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponseGet("/fine-tunes", responseBody);


        ListFineTuneResponse response = client.listFineTunes();
