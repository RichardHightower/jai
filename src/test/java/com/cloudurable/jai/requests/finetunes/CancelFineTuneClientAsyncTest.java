...
public class CancelFineTuneClientAsyncTest {
    ...
    void cancelFineTune() throws Exception {
        ...
        // Mock the response
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponsePostAsync("/fine-tunes/foo/cancel", responseBody);

        final FineTuneData response = client.cancelFineTuneAsync("foo").get();
