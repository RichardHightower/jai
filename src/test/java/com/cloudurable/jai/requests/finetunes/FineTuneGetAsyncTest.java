...
class FineTuneGetAsyncTest {
    ...
    void getFineTune() throws Exception {
        ...
        //Mock it
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponseGetAsync("/fine-tunes/ft-AF1WoRqd3aJAHsqc9NY7iL8F", responseBody);


        FineTuneData response = client.getFineTuneDataAsync("ft-AF1WoRqd3aJAHsqc9NY7iL8F").get();
