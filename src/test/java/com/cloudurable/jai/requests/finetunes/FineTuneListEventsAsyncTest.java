 ...
 */
class FineTuneListEventsAsyncTest {
    ...
    void listFineTunesAsync() throws Exception {
        ...
        //Mock it
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponseGetAsync("/fine-tunes/foo/events", responseBody);


        ListFineTuneEventResponse response = client.listFineTuneEventsAsync("foo").get();
