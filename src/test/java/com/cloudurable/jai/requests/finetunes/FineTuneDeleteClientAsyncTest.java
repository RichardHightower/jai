...
public class FineTuneDeleteClientAsyncTest {
    ...
    void deleteFineTune() throws Exception {
        ...
        // Mock the response
        final HttpClientMock.RequestResponse requestResponse = httpClientMock.setResponseDeleteAsync("/models/foo", responseBody);

        final DeleteFineTuneResponse response = client.deleteFineTuneAsync("foo").get();
